...
//
//    // 더미 Payment 데이터 생성
//    Payment payment1 = new Payment(trainer1, user1, store1, PtTimes.TEN_TIMES, ProductType.PT_SESSION, PaymentType.CREDIT_CARD, 1200.0, PaymentStatus.COMPLETED, LocalDateTime.now(), LocalDateTime.now().plusMonths(1), true);
//
