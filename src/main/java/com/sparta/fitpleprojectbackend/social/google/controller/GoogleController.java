package com.sparta.fitpleprojectbackend.social.google.controller;
...
import com.sparta.fitpleprojectbackend.social.google.service.GoogleService;
...
public class GoogleController {
  ...
  public ResponseEntity<CommonResponse<String>> googleLogin(@RequestParam String code) throws JsonProcessingException {
    ...
    CommonResponse<String> response = googleService.googleLogin(code);

    // JwtAccessToken 발급 또는 추가 정보 입력 메세지 출력
    return ResponseEntity.ok(response);
  }

  @PutMapping("/api/user/google/addInfo")
  public ResponseEntity<CommonResponse<String>> naverAddInfo(
    @AuthenticationPrincipal UserDetailsImpl userDetails,
    @RequestBody AddInfoRequestDto requestDto ) {

    googleService.googleUserAddInfo(userDetails, requestDto);
